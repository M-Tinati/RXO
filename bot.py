...
messages = [
    "🌟 *لینک حمایت* 🌟\n\n"
    "برای حمایت از ماریا و بزرگترین برگزار کننده دویل‌های کالاف موبایل، کافی‌ست روی لینک زیر کلیک کنید و با محبت خود ماریا را همراهی کنید!\n\n"
...
def schedule_messages():
    schedule.every(150).minutes.do(send_automatic_messages)  # ارسال هر 1 دقیقه
