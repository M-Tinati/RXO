...
messages = [
    ...
    "به زودی بزرگ ترین استریم پابجی موبایل توسط بزرگ ترین و حرفه ای ترین پرو پلیر پابجی در کشوری و بین المللی برگزار میشود. به زودی منتظر استریم های پابجی علیرضا خدای پابجی باشید
]
